        ...
        <div className="services-description container ">
          <div className="row m-5">
            <div className="col services-text">
              <h2 className="services-heading">Home Listing Platform</h2>
              <p>
                Our website provides a user-friendly platform for listing and
                searching for Home accommodations. We connect landlords and
                tenants, making it easier to find the perfect Home for your needs.
              </p>
            </div>
          ...
          <div className="row m-5">
            ...
            <div className="col services-text">
              ...
              <p>
                ...
                amenities, and more. Find your ideal Home with just a few clicks.
              </p>
            </div>
          </div>
          ...
          <div className="row m-5">
            <div className="col services-text">
              ...
              <p>
                ...
                stayed in Home accommodations. These reviews offer valuable
